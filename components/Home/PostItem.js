...
const PLACEHOLDER='./Images/explore.jpg'
function PostItem({post,modal=false}) {
  return (
   <>
{post?
  <div className="max-w-sm bg-white border
 border-gray-5000 rounded-lg shadow cursor-pointer
  dark:bg-gray-800 dark:border-gray-800 ">
    ...
    text-gray-900 dark:text-white">
      ...
      <div className='flex items-center dark:text-white gap-2 mb-2'>
  <span className='font-semibold'>Zip Code:</span> {post.zip}
</div>

        <p className="mb-3 font-normal
         text-gray-700 
         dark:text-gray-400" style={{ whiteSpace: "pre-line" }}>
          {post.desc}</p>
